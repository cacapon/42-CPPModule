...
static void test_sign_ok() {
    std::cout << "<<<sign test ok>>>" << std::endl;
    Bureaucrat a("Jiro", 42);
...
static void test_sign_ng() {
    std::cout << "<<<sign test ng>>>" << std::endl;
    Bureaucrat a("Taro", 42);
    Form f("TestForm", 30, 50);
    std::cout << "a=" << a << std::endl;
    std::cout << "f=" << f << std::endl;
